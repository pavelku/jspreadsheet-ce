            ...
            if (jssTable[1] == 1) {
                ...
                if (columnId) {
                    ...
                    if (libraryBase.jspreadsheet.current.options.columnResize != false && info.width - e.offsetX < 6) {
                        ...
                        console.log('select header 1, totalItemsInQuery = ', libraryBase.jspreadsheet.current.totalItemsInQuery);
                        // Update selection
                        selection/* updateSelectionFromCoords */.AH.call(libraryBase.jspreadsheet.current, o, 0, libraryBase.jspreadsheet.current.totalItemsInQuery, e); //libraryBase.jspreadsheet.current.options.data.length - 1
                    }
                } else {
