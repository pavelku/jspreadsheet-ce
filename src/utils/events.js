            ...
            if (jssTable[1] == 1) {
                ...
                if (columnId) {
                    ...
                    if (libraryBase.jspreadsheet.current.options.columnResize != false && info.width - e.offsetX < 6) {
                        ...
                        // Update selection
                        updateSelectionFromCoords.call(libraryBase.jspreadsheet.current, o, 0, libraryBase.jspreadsheet.current.totalItemsInQuery, totalItemsInQuery , e); //libraryBase.jspreadsheet.current.options.data.length - 1
                    }
                } else {
