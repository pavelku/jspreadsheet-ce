...
import { getHighlighted, getRange, getSelected, getSelectedColumns, getSelectedRows, chooseSelection, getSelection, isSelected, resetSelection, selectAll, updateSelectionFromCoords } from './selection.js'; // 
